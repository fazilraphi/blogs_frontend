      ...
      <div className="min-h-screen">
        ...
        <section className="relative pt-32 pb-20 px-6 text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex justify-center gap-4 pt-8">
              <Link
                href="/create"
                className="px-8 py-3 bg-[var(--color-apple-green)] text-black font-bold rounded-full hover:scale-105 transition-transform shadow-[0_0_20px_rgba(76,201,54,0.3)]"
              >
                Start Writing
              </Link>
              ...
              <Link
                href="/feed"
                className="px-8 py-3 glass text-white font-medium rounded-full hover:bg-white/10 transition-colors border border-white/10"
              >
                Read Feed
              </Link>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-16">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link
              href="/feed"
              className="text-[var(--color-apple-green)] hover:underline text-sm font-medium"
            >
              View all &rarr;
            </Link>
          </div>
