 ...
 export default function ProfileSettings() {
  ...
  return (
    ...
    <div className="max-w-2xl mx-auto mt-24 px-6 pb-20">
      ...
      <form onSubmit={handleSave} className="glass p-6 md:p-8 rounded-2xl border border-white/10 space-y-6">
         {loading ? (
            ...
            <div className="flex items-center space-x-4">
             ...
             <div className="flex gap-3">
               <button
                 type="submit"
                 disabled={saving}
                 className="px-6 py-3 bg-[var(--color-apple-green)] text-black font-semibold rounded-xl hover:bg-[var(--color-apple-green-hover)] transition-all shadow-[0_0_15px_rgba(76,201,54,0.3)] disabled:opacity-60"
               >
               ...
               {!onboarding && (
                 <button
                   type="button"
                   onClick={() => router.back()}
                   className="px-6 py-3 border border-white/15 text-white rounded-xl hover:bg-white/10 transition-all NB"
                 >
                   Cancel
                 </button>
               )}
